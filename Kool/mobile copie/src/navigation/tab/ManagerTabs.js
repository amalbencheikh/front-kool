...
import HomeStackNavigator from "../stacks/managerStacks/HomeStackNavigator";
import ProfileStackNavigator from "../stacks/managerStacks/ProfileStackNavigator";
import Notifications from "../../ui/screens/Manager/Notifications";
...
export default function ManagerTabs({navigation}) {
    return (
        <Tab.Navigator
            screenOptions={({route}) => ({
                    ...
                    if (route.name === routes.HOME_TAB) {
                        return <View
                            style={{
                                ...
                                // position:'absolute',
                                backgroundColor: !focused? colors.TRANSPARENT : colors.GREEN,
                                borderRadius: 50,
                                // top:-1,
                                // left:-1,
                                width:33,
